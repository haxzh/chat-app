...
//     try{
//         //1. if the user already exxit

//         const user = await User.findOne({email: req.body.email})
//         //2. if  user , already exxit send a error response
//         if(user){
...
//         //3 if the user exits and password is correct  , assign a jwt
